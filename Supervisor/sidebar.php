            ...
            <ul id="sidebarnav" class="pt-4">
              <li class="sidebar-item">
                <a
                  ...
                  ><span class="hide-menu">Supervisor Dashboard</span></a
                >
              </li>
              ...
              <li class="sidebar-item">
                <a
                  ...
                  ><span class="hide-menu">Company Registration </span></a
                >
                <ul aria-expanded="false" class="collapse first-level">
                  <li class="sidebar-item">
                    <a href="co-registrattion.php" class="sidebar-link"
                      ><i class="mdi mdi-note-outline"></i
                      ><span class="hide-menu"> register </span></a
                    >
                  </li>
                  <li class="sidebar-item">
                    <a href="Co-Profile.php" class="sidebar-link"
                      ><i class="mdi mdi-note-plus"></i
                      ><span class="hide-menu"> Co-Profile </span></a
                    >
                  </li>
                </ul>
              </li>
